...
//    PhotoDocumentActivity docContext;
    ...
    public ShowPhotoDialog(@NonNull Context context, PhotoActivity xxx, Photo m, Realm realm) {
...
//    public ShowPhotoDialog(@NonNull Context context, PhotoDocumentActivity xxx, Photo m, Realm realm) {
//        super(context, R.style.AppTheme);
//        try {
//            requestWindowFeature(Window.FEATURE_NO_TITLE);
//            //getWindow().setBackgroundDrawable(new ColorDrawable(android.graphics.Color.TRANSPARENT));
