...
public class HistorySitePresenter implements HistorySiteActivityInterface.Presenter {
    String TAG = getClass().getSimpleName();
    HistorySiteActivityInterface.View view;
    BaseActivity mContext;
    private Context hContext;

//    public HistorySitePresenter(BaseActivity context, HistorySiteActivityInterface.View view, String userName, String password) {
//        this.view = view;
//        mContext = context;
...
//    public HistorySitePresenter(HistorySiteActivity context, HistorySiteActivity historySiteActivity, String userName, String password) {
//    }
/*
   Swap screen method
 */
