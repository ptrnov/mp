...
import com.cudo.mproject.Menu.Site.Alamat.Actual.History.AlamatActualHistoryActivity;
import com.cudo.mproject.Menu.Site.IMB.History.IMBHistoryActivity;
import com.cudo.mproject.Menu.Site.PLN.History.PLNHistoryActivity;
...
public class AndroidTabHistoryActivity extends BaseActivity implements TabInterface.View, NavigationView.OnNavigationItemSelectedListener {
...
//        setContentView(R.layout.activity_tab_history);
        setContentView(R.layout.activity_main_tab_history_layout);
...
//        String is_offline = intent.getStringExtra("is_offline");
        ...
        Intent koordinatIntent = new Intent(this, AlamatActualHistoryActivity.class);//AlamatActualActivity
        ...
        Intent lahanIntent = new Intent(this, PersonHistoryActivity.class);//PersonActivity
        ...
        Intent imbIntent = new Intent(this, IMBHistoryActivity.class);
        ...
        Intent plnIntent = new Intent(this, PLNHistoryActivity.class);
