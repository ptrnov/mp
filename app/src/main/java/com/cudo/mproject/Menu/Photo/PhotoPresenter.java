...
public class PhotoPresenter implements PhotoInterface.Presenter {

    PhotoInterface.View view;
    BaseActivity mContext;

    public PhotoPresenter(PhotoInterface.View view, BaseActivity context) {
        this.view = view;
        mContext = context;
    }
        ...
        new AsyncJob.AsyncJobBuilder<Boolean>()
                .doInBackground(new AsyncJob.AsyncAction<Boolean>() {
                    ...
                    public Boolean doAsync() {
                        ...
                        return FileUtils.timestampItAndSave2(path, id, site_name, latlng,"png","p1");
                    }
                })
